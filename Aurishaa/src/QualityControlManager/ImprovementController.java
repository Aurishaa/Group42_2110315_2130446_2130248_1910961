...
public class ImprovementController implements Initializable {
    ...
    @FXML
    private TextField improvementTextField;
    @FXML
    ...
    private void addButtonOnMouseClick(ActionEvent event) {
        String improvement = improvementTextField.getText();
        String reason = reasonTextField.getText();

        if (improvement.isEmpty() || reason.isEmpty()) {
            System.err.println("Both fields must be filled.");
        return;
        }


        String fileName = "Improvement.bin";
