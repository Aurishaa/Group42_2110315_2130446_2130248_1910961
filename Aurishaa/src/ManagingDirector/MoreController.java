...
public class MoreController implements Initializable {
    ...
    @FXML
    private void viewSupplierInfoButtonOnClick(ActionEvent event) throws IOException {
           Parent mainSceneParent = FXMLLoader.load(getClass().getResource("/ManagingDirector/ViewSupplierInfo.fxml"));
